...
export default function ItemView({ item, tags, modifyItem, expired = false, deleteItem } = {}) {
  ...
  return (
    <div className='itemView d-flex flex-row justify-content-between align-items-center pb-2 pt-2 border-bottom'>
      ...
      <button className='btn btn-sm btn-outline-success ms-2' type='click' name="item-delete" id={item.id} onClick={onDelete}>Delete</button>
    </div>
  );
}
